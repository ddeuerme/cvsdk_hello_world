...
You will begin this tutorial by using the Model Optimizer to convert the included trained model to two Intermediate Representation (IR) files. Your result will be one .xml file and one .bin file. The Inference Engine requires that the model be converted to these IR files. 
...
This tuturial is important in your learning about deep learning and the Intel® CV SDK because of the real-life ways in which you can expand on this tutorial scenerio, and because this tutorial prepares you for more difficult deep learning scenarios. For example, this tutorial provides the basis of code for security functions like:
...
In addition, once you know how to identify individuals, you will be able expand on this tutorial's inference to search for other items, such as animals or vehicles to satisfy other use cases.
